...
public class DeployOpenCVTest {
    ...
    */
    ...
    /*
    Warning string written into the logs if the native library has not been processed by 'execstack' during the build.
    */
    private static final String EXECSTACK_WARNING_STRING =
